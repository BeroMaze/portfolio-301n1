var projects = [
  {
    ...
    publishedOn:  parseInt((new Date() - new Date('12/5/2015'))/60/60/24/1000),
  ...
  },
  {
    ...
    publishedOn:  parseInt((new Date() - new Date('11/29/2015'))/60/60/24/1000),
  ...
  },
  {
    ...
    publishedOn:  parseInt((new Date() - new Date('11/11/2015'))/60/60/24/1000),
  ...
  },
  {
    ...
    publishedOn:  parseInt((new Date() - new Date('10/30/2015'))/60/60/24/1000),
