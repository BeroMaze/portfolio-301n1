(function(module){
  ...
  script.fetchLocal = function(){
    if (localStorage.data){
      script.loadAll(JSON.parse(localStorage.data));
    }
    else {
